package com.ysten.ystenreport.encryption.imp;
...
public class AESEncode implements IEncryption {
     ...
     * 默认使用的加密的key
     */
    private final static String DEFAULT_KEY = "yeten_report";
    ...
    private static byte[] getRawKey(byte[] password) throws Exception {
        ...
        int sdkVersion = 0;
        if(!TextUtils.isEmpty(android.os.Build.VERSION.SDK)){
        	try {
